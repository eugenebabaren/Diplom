...
switch ($sort) {
    case 'confirmed':
        ...
        $sort_name = 'Отвеченные';
        break;

    case 'no-confirmed':
        $sort = "confirmed='no' DESC";
        $sort_name = 'Неотвеченные';
        break;
        ...
        <div class="finder ml-3 mr-2 mb-0 justify-content-between">
            ...
            <div class="card mb-3 wow fadeIn">
                <div class="card-body d-sm-flex">
                    ...
                    $all_count = mysqli_query($link, "SELECT * FROM feedback");
                    $all_count_result = mysqli_num_rows($all_count);

                    $buy_count = mysqli_query($link, "SELECT * FROM feedback WHERE confirmed='yes'");
                    $buy_count_result = mysqli_num_rows($buy_count);

                    $no_buy_count = mysqli_query($link, "SELECT * FROM feedback WHERE confirmed='no'");
                    $no_buy_count_result = mysqli_num_rows($no_buy_count);

                    ?>
                    <h4 class="mt-3 mr-4">Всего писем - <span class="font-weight-bold"><?php echo $all_count_result ?></span></h4>
                    <h4 class="mt-3 mr-4">Отвеченных - <span class="font-weight-bold"><?php echo $buy_count_result ?></span></h4>
                    <h4 class="mt-3 mr-4">Неотвеченных- <span class="font-weight-bold"><?php echo $no_buy_count_result ?></span></h4>
                    ...
                    <div class=" ml-auto">
                        ...
                        <div class="dropdown-menu">
                            <a href="feedback.php?sort=confirmed" class="dropdown-item">Отвеченные</a>
                            <a href="feedback.php?sort=no-confirmed" class="dropdown-item">Неотвеченные</a>
                            <div class="dropdown-divider"></div>
                            <a href="feedback.php" class="dropdown-item btn-danger">Без сортировки</a>
                        </div>
                        ';
                        ?>
            ...
            <section class="col mb-3 p-0">
                <div class="card wow fadeIn d-flex m-0 p-4">
                    ...
                    $query_reviews = mysqli_query($link, "SELECT * FROM feedback ORDER BY $sort");
                            ...
                            echo '
                                    <div class="row ml-1 pt-2">
                                        <div class="col-lg-6 text-left">
                                            ...
                                            <a href="view_feedback.php?id=' . $row_reviews["id"] . '" class="ml-auto mr-3 h-75">
