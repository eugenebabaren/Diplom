...
if (isset($_POST['add_news_form_submit'])) {
    ...
    if (empty($error)) {
        ...
        mysqli_query($link, "INSERT INTO news(title, image, text, date)
            values('" . $_POST["title"] . "',
                   '" . $newfilename . "',
                   '" . $_POST["descr"] . "',
                   NOW()
                ...
                <div class="col-auto ml-1 mt-2">
                    <form method="POST" enctype="multipart/form-data" class="ml-4">
                        ...
                        <div id="form-profile">
                            ...
                            <textarea type="text" name="descr" id="descr" class="form-control mb-2 w-75" placeholder="Описание" rows="10"></textarea>
