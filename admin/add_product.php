...
if (isset($_POST['add_product_form_submit'])) {
    ...
    if (empty($error)) {
        ...
        if (mysqli_query($link, "SELECT * FROM category WHERE brand='{$_POST["brand"]}' AND category='{$_POST["category"]}'")) {
        } else {
                    ...
                    <form method="POST" enctype="multipart/form-data" id="form_profile" class="ml-4">
                        ...
                        <div id="form-profile">
                            ...
                            <div class="row">
                                ...
                                <a href="" class="mt-2 ml-4 pl-1 text-success">
                            ...
                            <label data-error="wrong" data-success="right" for="upload_image">Изображение</label>
                            <div class="custom-file mb-4" id="image">
                                <input name="MAX_FILE_SIZE" type="hidden" value="5000000">
                                <input name="upload_image" type="file" class="custom-file-input w-75" lang="ru" accept="image/jpg,image/jpeg,image/png">
