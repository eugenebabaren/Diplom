      ...
      <div class="card wow fadeIn d-flex mt-5 mb-3">
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          <div class="row m-4">
            ...
            <a class="add-cart text-left" id="add-cart-view">
            <button disabled class="btn btn-success btn-rounded mt-4 mb-2">
              <i class="fas fa-shopping-basket mr-2" aria-hidden="true"></i>
              В корзину
            </button>
          </a>
        ...
        <div class="font-weight-bold mr-3 text-left ml-5 mb-5">
          ...
          <button id="write_review_btn" class="btn btn-warning mb-3 ml-0" data-toggle="modal" data-target="#modalReviewForm">
          ...
          if (mysqli_num_rows($query_reviews) > 0) {
            ...
            echo '
          <h3 class="h3-responsive text-left text-md-left mb-1 ml-xl-0 mb-4 mt-4">Отзывов к данному товару еще нет</h3>
          ';
          }
